...
export default function LoginForm() {
  ...
  const { loginUser, resendConfiramtionEmail } = useAccount();
  ...
  const handleResendEmail = async () => {
    try {
      await resendConfiramtionEmail.mutateAsync({ email });
      ...
      {notVerified ? (
        <Box display="flex" flexDirection="column" justifyContent="center">
          <Typography textAlign="center" color="error">
            Yout email has not been verified. You can click the button to
            resend.
          </Typography>
          <Button
