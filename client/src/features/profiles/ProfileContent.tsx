...
import ProfilesFollowings from "./ProfilesFollowings";
...
export default function ProfileContent() {
  ...
  const tabContent = [
    ...
    { label: "Followers", content: <ProfilesFollowings activeTab={value}/> },
    { label: "Following", content: <ProfilesFollowings activeTab={value}/>},
  ];
